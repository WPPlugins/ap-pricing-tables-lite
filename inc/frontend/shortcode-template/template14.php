							...
							<div class="appts-table-item" >
								<div class="appts-table-item-wrap">
									<?php if(isset($remove_header) && $remove_header !='1'){ ?>
										<div class="appts-table-header-wrapper" <?php if( isset($new_feature_image) && $new_feature_image !='' && $template == 'template_02'){ echo "style='background:url($new_feature_image)';"; } ?> >
											<div class="appts-header-wrap">
												...
												<div class='appts-price-rating-wrapper'>
													<?php
														if( ( $price['type']=='price' && ($price['price']['selling-price']['content'] !='' || $price['price']['payment-name']['content'] !='')) || ( $price['type']=='price-html' && ($price['html']['selling-price-content']['content'] !='' || $price['payment-content']['content'] !='')) ){ ?>
