...
if($new_feature_image =='' && (isset($title['subtitle']['content']) && $title['subtitle']['content'] =='') && (isset($title['title']['content']) && $title['title']['content'] == '')){
	...
	<div class="appts-table-title-wrapper <?php if($remove_header =='1'){ echo "header_removed "; } if(isset($new_feature_image) && ($new_feature_image !='')){ echo "appts-feature-image"; } ?>" <?php echo $optional_image_background; ?>>
