						...
						<div class="appts-table-header-wrapper <?php echo esc_attr($dynamic_classes); ?>" <?php echo esc_attr($dynamic_css); ?> >
							<?php if(isset($remove_header) && $remove_header !='1'){ ?>
									<div class='appts-title-price-wrap'>
										...
										if(isset($price['type'])){  ?>
										<div class="appts-pricing-info <?php if($price['type'] == 'price-html'){ echo "appts-pricing-html-info"; } ?>" >
												...
												<div class="appts-pricing-info-div-again">
													...
													if($price['type'] == 'price'): ?>
														<div class="appts-price-value-wrap" >
															...
															<?php if($currency_position == 'left'){ echo "<span class='appts-currency-symbol'>".$currency_symbol.'</span>'; } 
																...
																if($currency_position == 'right'){ echo $currency_symbol; } ?>
															<?php
																//////////////////payment name ////////////////////////////
