...
if(isset($price['type']) && $price['type'] == 'price'): ?>
	<div class="payment-overall-wrap">
		<div class="appts-price-value-wrap">
			...
			<?php
			if(isset($price_selling) && $price_selling !=''){  ?>
				<span class='appts-selling-value'><?php if($currency_position == 'left'){ echo "<span class='appts-currency-symbol'>".$currency_symbol.'</span>'; } echo "<span class='appts-integer'>".$amount_selling."</span><span class='appts-decimal'>".$currency_decimal_separator.$amount_selling_decimal.'</span>'; if($currency_position == 'right'){ echo "<span class='appts-currency-symbol'>".$currency_symbol.'</span>'; } ?>
					<?php ob_start(); ?>
