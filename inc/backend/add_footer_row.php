			    ...
			    <div class="appts-content-settings">
			        <div class="appts-input-wrap appts-input-field-block">
						...
						<div class="appts-input-field-wrapper appts-input-button appts-textarea-code">
		            		<textarea name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][html][content][content]" id='appts-<?php echo self:: generateRandomString(); ?>' class='appts-insert-icons'><?php if( isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['content']) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['content'] !='' ){ echo esc_textarea($table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['content']); } ?></textarea>
				...
				<div class='appts-style-settings'>
		            ...
		            <div class="appts-input-wrap">
		                ...
		                <div class="appts-info-wrap">
		                	<select name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][html][content][style][font-family]">
	                            ...
	                            ?>
	                            <option value="<?php echo $key; ?>" <?php if(isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-family'])){ selected( $key, $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-family'] ); } ?> ><?php echo $key; ?></option>
	                            <?php
	                            endforeach;
	                            ?>
		                    </select>
		            ...
		            <div class='appts-input-wrap appts-input-manage'>
		                ...
		                <div class="appts-info-wrap appts-table-row appts-input-manage">
		                	<input type="text" name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][html][content][style][font-size]" value="<?php if( isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-size']) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-size'] !='' ){ echo esc_attr($table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-size']); } ?>">
		                	<div class="appts-font-properties">
		                		<a href="javascript:void(0);" title="<?php _e( 'Bold', 'ap-pricing-tables-lite' ); ?>" 			data-action="font-style-bold"			<?php if(isset( $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['bold'] ) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['bold'] =='1' ) { ?> class="appts-active" <?php } ?> >					<i class="fa fa-bold"></i>			<input type="hidden" name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][html][content][style][font-style][bold]" 			value="<?php if( isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['bold']) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['bold'] =='1' ) { 					echo $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['bold']; 			} ?>"></a>
								<a href="javascript:void(0);" title="<?php _e( 'Italic', 'ap-pricing-tables-lite' ); ?>" 		data-action="font-style-italic"			<?php if(isset( $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['italic'] ) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['italic'] =='1' ) { ?> class="appts-active" <?php } ?> >				<i class="fa fa-italic"></i>		<input type="hidden" name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][html][content][style][font-style][italic]" 			value="<?php if( isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['italic']) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['italic'] =='1' ){ 				echo $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['italic']; 		} ?>"></a>
								<a href="javascript:void(0);" title="<?php _e( 'Strikethrough', 'ap-pricing-tables-lite' ); ?>" 	data-action="font-style-strikethrough"	<?php if(isset( $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['strikethrough'] ) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['strikethrough'] =='1' ) { ?> class="appts-active" <?php } ?> >	<i class="fa fa-strikethrough"></i>	<input type="hidden" name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][html][content][style][font-style][strikethrough]" 	value="<?php if( isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['strikethrough']) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['strikethrough'] =='1' ){ echo $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['strikethrough']; } ?>"></a>
								<a href="javascript:void(0);" title="<?php _e( 'Underline', 'ap-pricing-tables-lite' ); ?>" 		data-action="font-style-underline"		<?php if(isset( $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['underline'] ) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['underline'] =='1' ) { ?> class="appts-active" <?php } ?> >			<i class="fa fa-underline"></i>		<input type="hidden" name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][html][content][style][font-style][underline]" 		value="<?php if( isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['underline']) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['underline'] =='1' ){ 		echo $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['font-style']['underline']; 	} ?>"></a>
		                	</div>
		            ...
		            <div class="appts-input-wrap">
					    <label><?php _e( 'Text Color', 'ap-pricing-tables-lite' ); ?></label>
						  <div class='appts-info-wrap'>
						  	<input type="text" name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][html][content][style][text-color]" class='appts-default-colorpicker' data-alpha="true" value="<?php if( isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['text-color']) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['text-color'] !='' ){ echo esc_attr($table_data['appts-col-data'][$column_index]['footer'][$row_index]['html']['content']['style']['text-color']); } ?>">
						  </div>
					</div>
				</div>
			...
			<div class='appts-select-common-div appts-button' <?php if(isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['type']) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['type']=='button'){ ?> style='display:block;' <?php }else{ ?> style='display:none;' <?php } ?>>
				...
				<div class='appts-content-settings'>
			        <div class="appts-input-wrap">
						...
						<div class="appts-textarea-code">
							<input type='text' name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][button][text]" value="<?php if( isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['text']) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['text'] !='' ){ echo esc_attr($table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['text']); } ?>" />
						</div>
					</div>
					<div class="appts-input-wrap">
						<label><?php _e( 'Link', 'ap-pricing-tables-lite' ); ?></label>
						<div class="appts-info-wrap">
							<input type='url' name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][button][link]" value="<?php if( isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['link']) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['link'] !='' ){ echo esc_url($table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['link']); } ?>" />
						</div>
					</div>
					<div class="appts-input-wrap">
		        ...
		        <div class='appts-style-settings'>
		            ...
		            <div class="appts-input-wrap appts-table-row">
						...
						<div class="appts-info-wrap">
							<select name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][button][style][font-family]">
					            ...
					            foreach ($appts_pricing['google-fonts'] as $key=>$value ) :
					            ?>
					            <option value="<?php echo $key; ?>" <?php if(isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-family'])){ selected( $key, $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-family'] ); } ?> ><?php echo $key; ?></option>
					            <?php
					            endforeach;
					            ?>
							</select>
					...
					<div class="appts-input-wrap appts-table-row appts-input-manage">
						<label><?php _e( 'Font Size (px)', 'ap-pricing-tables-lite' ); ?></label>
						<div class="appts-info-wrap appts-table-row appts-input-manage">
								<input type="text" name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][button][style][font-size]" value="<?php if( isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-size']) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-size'] !='' ){ echo esc_attr($table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-size']); } ?>" class="appts-input-mid">
								<div class="appts-font-properties">
									<a href="javascript:void(0);" title="<?php _e( 'Bold', 'ap-pricing-tables-lite' ); ?>" 			data-action="font-style-bold"			<?php if(isset( $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['bold'] ) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['bold'] =='1' ) { ?> class="appts-active" <?php } ?> >						<i class="fa fa-bold"></i>			<input type="hidden" name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][button][style][font-style][bold]" 			value="<?php if( isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['bold']) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['bold'] =='1' ) { 					echo $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['bold']; 			} ?>"></a>
									<a href="javascript:void(0);" title="<?php _e( 'Italic', 'ap-pricing-tables-lite' ); ?>" 		data-action="font-style-italic"			<?php if(isset( $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['italic'] ) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['italic'] =='1' ) { ?> class="appts-active" <?php } ?> >					<i class="fa fa-italic"></i>		<input type="hidden" name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][button][style][font-style][italic]" 			value="<?php if( isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['italic']) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['italic'] =='1' ){ 				echo $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['italic']; 		} ?>"></a>
									<a href="javascript:void(0);" title="<?php _e( 'Strikethrough', 'ap-pricing-tables-lite' ); ?>" 	data-action="font-style-strikethrough"	<?php if(isset( $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['strikethrough'] ) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['strikethrough'] =='1' ) { ?> class="appts-active" <?php } ?> >	<i class="fa fa-strikethrough"></i>	<input type="hidden" name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][button][style][font-style][strikethrough]" 	value="<?php if( isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['strikethrough']) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['strikethrough'] =='1' ){ 	echo $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['strikethrough']; 	} ?>"></a>
									<a href="javascript:void(0);" title="<?php _e( 'Underline', 'ap-pricing-tables-lite' ); ?>" 		data-action="font-style-underline"		<?php if(isset( $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['underline'] ) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['underline'] =='1' ) { ?> class="appts-active" <?php } ?> >			<i class="fa fa-underline"></i>		<input type="hidden" name="appts-col-data[<?php echo $column_index; ?>][footer][<?php echo $row_index; ?>][button][style][font-style][underline]" 		value="<?php if( isset($table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['underline']) && $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['underline'] =='1' ){ 			echo $table_data['appts-col-data'][$column_index]['footer'][$row_index]['button']['style']['font-style']['underline']; 		} ?>"></a>
								</div>
						</div>
					</div>
		        </div>
